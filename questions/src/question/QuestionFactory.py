...
#                file_a.write('\n')
    ...
    def __get_question__(qtype):
        ...
        if qtype == 127:
            ...
            return Question128()
        if qtype == 128:
            from .Question129 import Question129
            return Question129()
        if qtype == 129:
            from .Question130 import Question130
            return Question130()
        if qtype == 130:
            from .Question131 import Question131
            return Question131()
        if qtype == 131:
            from .Question132 import Question132
            return Question132()
        if qtype == 132:
            from .Question133 import Question133
            return Question133()
        if qtype == 133:
            from .Question134 import Question134
            return Question134()
        if qtype == 134:
            from .Question135 import Question135
            return Question135()
        if qtype == 135:
            from .Question136 import Question136
            return Question136()
