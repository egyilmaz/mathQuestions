...
class Question111(BaseQuestion):
    def __init__(self):
        ...
        self.body = "For a can of baked bean, we need a can, 100grs of beans, 50grs of tomato. If the tomatoes " \
                    "cost {1}pence per 500gr, beans cost {2}pence per kg and cans cost {3}pence for a bundle of 10 can, what will be the " \
                    "cost of {3} cans of baked beans in pounds and pence"\
