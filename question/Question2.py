...
class Question2:
    ...
    def __init__( self):
        ...
        (self.subj1, self.subj2)=get_two_distinct(Question2.subjects)
        (self.subj1_qty, self.subj2_qty) = get_two_distinct(Question2.qty)
        self.item = random.choice(Question2.items)
